...
# =============================================
# YourProject SQL Server Container Setup Script
# =============================================

set -e

echo "=========================================="
echo "YourProject SQL Server Docker Setup"
echo "=========================================="
echo ""
...
echo "Configuration:"
echo "  - Container Name: ${CONTAINER_NAME:-sqlserver-dev}"
...
if docker ps -a --format '{{.Names}}' | grep -q "^${CONTAINER_NAME:-sqlserver-dev}$"; then
    echo "WARNING: Container '${CONTAINER_NAME:-sqlserver-dev}' already exists"
...
while [ $retry_count -lt $max_retries ]; do
    if docker inspect --format='{{.State.Health.Status}}' ${CONTAINER_NAME:-sqlserver-dev} 2>/dev/null | grep -q "healthy"; then
...
echo "  docker exec -it ${CONTAINER_NAME:-sqlserver-dev} /opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P '${SA_PASSWORD}'"
echo ""
echo "=========================================="
