...
A complete SQL Server test environment for CAP-DAMS development, featuring Docker-based SQL Server 2022, Claude AI agent skills, and automated database management.
...
- Schema templates for CAP-DAMS testing
...
- **Username:** `sa`
- **Password:** `Pass@word1`
- **Default Database:** `testdb` or `capdamstest`
...
# Execute script
docker exec -it dams-sqlserver-dev /opt/mssql-tools18/bin/sqlcmd \
...
**Repository:** https://github.com/asbassan/AgentsOfAction
**Team:** CAP-DAMS Data Engine
