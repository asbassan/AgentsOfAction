...
1. **SQL Server 2022** (default) - Full-featured, best for CAP-DAMS testing
...
| **Size** | ~1.5 GB |
| **Container Name** | `dams-azuresql-dev` |
| **Memory** | 4 GB |
| **CPUs** | 2 cores |
...
| **Username** | `sa` |
| **Password** | `Pass@word1` |
| **Connection String** | `Server=localhost,1433;Database=testdb;User Id=sa;Password=Pass@word1;TrustServerCertificate=True;` |
...
✅ Testing CAP-DAMS scripts (GetUnusedIndexes.sql, DropIndex.sql, etc.)
...
### Q: Which engine should I use for CAP-DAMS testing?
...
### Q: Can I run CAP-DAMS scripts on Azure SQL Edge?
...
```bash
docker stats dams-azuresql-dev
```
