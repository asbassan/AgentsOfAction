...
- **Posted PR comments** via Azure REST API
  ...
  - View at: https://msazure.visualstudio.com/CDS/_git/CAP-DAMS/pullrequest/14514176
...
```bash
az rest --method post \
  --uri "https://dev.azure.com/msazure/CDS/_apis/git/repositories/CAP-DAMS/pullRequests/14514176/threads?api-version=7.1" \
...
- **Script Author**: amarpb (Amarpreet Bassan)
- **Test Author**: amarpb (Amarpreet Bassan)
